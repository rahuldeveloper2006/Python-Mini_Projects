...
list1=[]
if(wish=="yes"):
    speaker.speak(f"thank you  ,{name}  ,for agree to give order, please select the food from list ")
    while "true":
         print("coffe:50\n tea:20 \n blue cooldrinks:160 \n burger:200 \n chicken tenduri:250 \n cake:150 \n ice-cream:50")
         ...
         order2=input("are you want to order next item say yes or no : ")
         if(order2=="no"):
    ...
    print(f"your total amount is : {count}")
    speaker.speak(f"your total amount is {count} ")
